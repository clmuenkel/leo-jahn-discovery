...
const pillars = [
  {
    ...
    stat: 78,
    label: "Reaktionszeit",
    sublabel: "Der Erstreagierende gewinnt",
    bullets: [
      "78 % der Kunden kaufen beim Erstreagierer.",
      "21x höhere Conversion, wenn Sie in unter 5 Minuten antworten.",
    ],
    painPoint: "Wer langsamer ist als die Konkurrenz - verliert",
    solutions: [
      "KI-Sprachassistenten",
      "Lead-Zentrale & Sofort-Antwort",
  ...
  },
  {
    ...
    sublabel: "Die Nachfass-Lücke",
    bullets: [
      "80 % der Verkäufe erfordern 5+ Kontaktpunkte.",
      "44 % der Betriebe geben nach dem ersten Versuch auf.",
    ],
    painPoint: "Kein Nachfassen - kein Umsatz",
    solutions: [
      "Follow-up-Automatisierungen",
      "Sofort-Angebote",
      "KI-optimierte Preisstrategie",
    ],
  ...
  },
  {
    ...
    stat: 57,
    label: "Reputation",
    sublabel: "Die Vertrauenshürde",
    bullets: [
      "57 % der Kunden wählen nur Betriebe mit 4+ Sternen.",
      "73 % vertrauen nur Bewertungen aus dem letzten Monat.",
    ],
    painPoint: "Keine Bewertungen - schlechtes Rating - keine Kunden",
    solutions: [
      "Empfehlungs-Optimierer",
      "Stimmungsbasiertes Routing",
      "Suchmaschinenoptimierung",
    ],
