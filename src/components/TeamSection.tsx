...
const team: TeamMember[] = [
  {
    ...
    title: "Gründer | Leiter Prozessoptimierung",
    ...
    fields: [
      ...
      },
      {
        icon: Building2,
        label: "Zuvor",
        value: "Celonis — weltweit #1 in Prozessoptimierung",
      },
      {
        icon: Crosshair,
        label: "Fokus",
        value: "Leitet Discovery und Prozessanalyse für jedes EVIOS-Projekt",
      },
    ],
  },
  {
    name: "Zad Iqbal",
    title: "Leiter Partnerschaften",
    image: "/team/zad.png",
    ...
    fields: [
      {
        icon: Building2,
        label: "Software",
        value: "4 Jahre Software-Erfahrung bei Amazon",
      },
      {
        icon: Building2,
        label: "Vertrieb",
        value: "3 Jahre technischer Vertrieb & Kundenbeziehungen bei Bridgepointe",
      },
      {
        icon: Crosshair,
        label: "Fokus",
        value: "Sorgt dafür, dass jede Kundenbeziehung langfristig Bestand hat",
      },
    ],
  },
  {
    name: "Facundo Llamas",
    title: "Leiter Technologie",
    ...
    fields: [
      {
        icon: Building2,
        label: "Zuvor",
        value: "3 Jahre Technologie- und Software-Erfahrung bei PwC",
      },
      {
        icon: Crosshair,
        label: "Erfolgsbilanz",
        value: "Über 25 SaaS-Tools und Automatisierungen entwickelt und ausgerollt",
      },
      {
        icon: Crosshair,
        label: "Fokus",
        value: "Entwirft und baut jede individuelle Lösung bei EVIOS",
      },
    ],
  },
];
