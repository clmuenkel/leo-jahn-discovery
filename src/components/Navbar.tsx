...
export default function Navbar({ companyName }: NavbarProps) {
  ...
  const isPersonalized = companyName && companyName !== "Ihr Unternehmen";
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="flex items-center gap-7 text-[13px] text-text-secondary font-medium">
              ...
              <a href="#process" className="hover:text-text transition-colors">Prozess</a>
              <a href="#insights" className="hover:text-text transition-colors">Einblicke</a>
              <a href="#loesungen" className="hover:text-text transition-colors">Lösungen</a>
              <a href="#discovery" className="hover:text-text transition-colors">Analyse</a>
            </div>
          </div>
        </div>
      </div>
