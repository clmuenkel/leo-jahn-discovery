...
const stages: Stage[] = [
  {
    ...
    prompt:
      "Wie finden neue Kunden zu Ihnen? Telefonanrufe, Website-Formulare, Empfehlungen, Werbung?",
  },
  {
    id: "scheduling",
    icon: Calendar,
    title: "Terminplanung",
    prompt:
      "Wie buchen und bestätigen Sie Termine? Welche Tools oder Software nutzen Sie?",
  },
  {
    id: "dispatch",
    icon: MapPin,
    title: "Einsatzplanung",
    prompt: "Wie werden Techniker zugeteilt und zu den Einsatzorten geschickt?",
  },
  {
    id: "service",
    icon: Wrench,
    ...
    prompt:
      "Wie sieht der Arbeitsablauf des Technikers vor Ort aus?",
  },
  {
    id: "invoicing",
    icon: Receipt,
    title: "Abrechnung",
    prompt:
      "Wie werden Aufträge abgerechnet? Wie sieht der Zahlungsprozess aus?",
  },
  {
    id: "followup",
    icon: UserCheck,
    title: "Nachbetreuung",
    prompt:
      "Was passiert nach dem Auftrag? Bewertungen, Folgeaufträge, Wartungsverträge?",
  },
];
      ...
      <div className="mx-auto max-w-5xl px-6 relative z-10">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            Gemeinsam Ihren Prozess verstehen
          </h2>
          <p className="mt-3 text-text-secondary max-w-lg mx-auto">
            Führen Sie uns durch jeden Schritt. Markieren Sie, wo es hakt.
          </p>
        </ScrollReveal>
                      ...
                      <div className="space-y-3 mb-4">
                        {sd.painPoints.length === 0 && !addingPoint && (
                          <p className="text-text-muted text-sm py-8 text-center">
                            Noch keine Problemstellen markiert
                          </p>
                        )}
                      ...
                      {addingPoint && (
                        ...
                        >
                          <input
                            ...
                            placeholder="Problemstelle beschreiben..."
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold">
                    {totalPainPoints} Problemstelle
                    {totalPainPoints !== 1 ? "n" : ""} identifiziert
                  </p>
