...
const fields: Field[] = [
  {
    ...
    icon: Users,
    label: "Teamgröße",
    subtitle: "Wie viele Personen arbeiten im Betrieb?",
    type: "dual-pills",
    dualGroups: [
      {
        id: "fieldWorkers",
        label: "Monteure / Techniker",
        icon: HardHat,
  ...
  },
  {
    id: "jobVolume",
    icon: Briefcase,
    label: "Aufträge pro Woche",
    subtitle: "Durchschnittliches wöchentliches Auftragsvolumen über alle Techniker.",
    type: "pills",
    options: ["Unter 10", "10–25", "25–50", "50–100", "100+"],
  },
  {
    id: "responseTime",
    icon: Clock,
    label: "Antwortzeit bei Anfragen",
    subtitle: "Wie schnell hört ein neuer Interessent von Ihnen?",
    type: "pills",
    options: ["< 5 Min.", "5–30 Min.", "30 Min.–1 Std.", "1–4 Std.", "4+ Std.", "Nicht erfasst"],
  },
  {
    id: "software",
    icon: Laptop,
    label: "Aktuelle Software",
    subtitle: "Welche Tools nutzt das Team im Alltag?",
    type: "chips",
    options: [
      "ServiceTitan",
      "Housecall Pro",
    ...
    allowCustom: true,
    customPlaceholder: "Andere hinzufügen...",
  },
  {
    id: "goals",
    icon: Target,
    label: "Wichtigste Ziele",
    subtitle: "Was ist in den nächsten 6–12 Monaten am wichtigsten?",
    type: "chips",
    options: [
      "Umsatz steigern",
      "Kosten senken",
    ...
    allowCustom: true,
    customPlaceholder: "Eigenes Ziel hinzufügen...",
  },
];
