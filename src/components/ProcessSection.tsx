...
const steps = [
  {
    ...
    title: "Analyse",
    free: true,
    headline: "Ihr Geschäft im Detail verstehen",
    description:
      "Wir verstehen Ihr Unternehmen tiefgehend - Arbeitsabläufe, Problemstellen und Wachstumsziele.",
    points: [
      "Umfassende Bestandsaufnahme Ihrer aktuellen Prozesse",
      "Ihre Geschäftsprozesse End-to-End abbilden",
      "Automatisierungspotenzial ermitteln & Prioritäten setzen",
    ],
  },
  {
    icon: Code,
    ...
    free: true,
    headline: "Bauen. Testen. Perfektionieren.",
    description:
      "Wir bauen maßgeschneiderte Lösungen, die sich in Ihre Tools einfügen - und Sie testen, bevor Sie sich festlegen.",
    points: [
      "Individuelle Software & Automatisierungen für Sie entwickelt",
      "Direkte Integration mit Ihren bestehenden Tools",
      "Test in Ihrer Umgebung, bis alles passt",
    ],
  },
  {
    icon: Rocket,
    number: "03",
    title: "Implementieren & Begleiten",
    free: false,
    headline: "Mit Sicherheit live gehen",
    description:
      "Nahtlose Einführung mit persönlichem Onboarding und langfristiger Betreuung.",
    points: [
      "Nahtlose Implementierung in Ihre Umgebung",
      "Kostenloses Onboarding & Schulung durch unsere Experten",
      "Kontinuierlicher Support mit 1 Jahr Garantie",
    ],
  },
];
      ...
      <div className="mx-auto max-w-5xl px-6 relative z-10">
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="mt-3 text-text-secondary max-w-md mx-auto">
            Kostenlose Analyse. Kostenlose Entwicklung. Sie zahlen erst, wenn es funktioniert.
          </p>
        </ScrollReveal>
